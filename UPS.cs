...
namespace UPSShipping
{
    public class UPS
    {
        ...
        private string m_uri = "https://wwwcie.ups.com/ups.app/xml/Rate?";
        ...
        public string buildUPSXml(string weight, string shipperZipCode, string shipperCountryCode, string destinationZipCode, string destinationCountryCode, string serviceCode)
        {
            ...
            sb.Append("<?xml version='1.0'?>");
              ...
              sb.Append("   <ShipTo>");
              sb.Append("    <Address>");
              sb.Append("       <ResidentialAddressIndicator/>");                         //========== If You want to calculate shiiping for Commertial address then remove it or for Residential  address it will be ok
